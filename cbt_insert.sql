...
VALUES
    (
        ...
        'link_login_operator',
        'ya',
        'Menampilkan Link Login Operator'
    ),
    (
        2,
        'cbt_nama',
        'Computer Based-Test',
        'Nama Penyelenggara CBT'
    ),
    (
        3,
        'cbt_keterangan',
        'Ujian Online Berbasis Komputer',
        'Keterangan Penyelenggara CBT'
    ),
    (
        4,
        'cbt_mobile_lock_xambro',
        'tidak',
        'Melakukan Lock pada browser mobile agar menggunakan Xambro Saja'
    ),
    (
        5,
        'cbt_informasi',
        ...
        'Informasi yang diberikan di Dashboard peserta tes'
    );

INSERT INTO
    `cbt_modul` (`modul_id`, `modul_nama`, `modul_aktif`)
VALUES
    (9, 'Default', 1);

INSERT INTO
    `user_level` (`id`, `level`, `keterangan`)
VALUES
...
VALUES
    ...
    (
        ...
        'modul',
        'modul-import',
        'Import Soal Spreadsheet',
        'manager/modul_import',
        'fa fa-circle-o',
        4
    ),
    (
    ...
    (
        ...
        1,
        'tool',
        'tool-exportimport-soal',
        'Export / Import Soal',
        'manager/tool_exportimport_soal',
        'fa fa-circle-o',
        2
    ),
    (
    ...
    (
        ...
        'Analisis Butir Soal',
        'manager/laporan_analisis_butir_soal',
        'fa fa-circle-o',
        1
    ),
    (
    ...
    (
        ...
        'modul-import-word',
        'Import Soal Word',
        'manager/modul_import_word',
        'fa fa-circle-o',
        4
    );

INSERT INTO
    `user_akses` (`id`, `level`, `kode_menu`, `add`, `edit`)
VALUES
