                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>Foto</label>
                                <input type="file" class="form-control" id="tambahfoto" name="tambahfoto" placeholder="Foto peserta (Boleh dikosongkan)">
                            </div>
                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>Foto</label>
                                <input type="file" class="form-control" id="edit-foto" name="editfoto">
                            </div>
