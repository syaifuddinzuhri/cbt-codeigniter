...
<head>
  ...
  <meta name="description" content="Aplikasi Ujian Online MA NU Sunan Giri Prigen">
  <meta name="keywords" content="Aplikasi Ujian Online MA NU Sunan Giri Prigen">
  <meta name="author" content="Syaifuddin Zuhri">
  <link rel="shortcut icon" href="<?php echo base_url(); ?>public/images/logo_ma.png" type="image/png">
  <!-- Bootstrap 3.3.4 -->
...
<body class="skin-green layout-top-nav">
  <div class="wrapper">
        ...
        <div class="container">
          <div class="navbar-header">
            <a href="<?php echo base_url(); ?>" class="navbar-brand">
              <img class="img-responsive" src="<?php echo base_url(); ?>public/images/logo_ma.png" alt="Logo" />
            </a>
          </div>
    ...
    <footer class="main-footer no-print">
      ...
      <div class="container">
        <strong>&copy; 2021 Syaifuddin Zuhri</strong>
      </div><!-- /.container -->
    </footer>
  </div><!-- ./wrapper -->
