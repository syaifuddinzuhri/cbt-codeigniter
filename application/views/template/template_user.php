...
<head>
  ...
  <meta name="description" content="Aplikasi Ujian Online MANUSGI CBT">
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <nav class="navbar navbar-static-top">
        <div class="container">
          <style>
            /* CSS Manual untuk mengatur Logo dan Teks */
            .custom-navbar-brand {
              display: flex;
              align-items: center;
              /* Membuat logo dan teks sejajar vertikal */
              gap: 10px;
            ...
            .custom-navbar-brand img {
              height: 35px;
              /* Atur tinggi logo agar pas di navbar */
              width: auto;
              /* Lebar otomatis mengikuti proporsi logo */
              display: inline-block;
            }

            .custom-navbar-brand b {
              font-size: 18px;
          ...
          <div class="navbar-header">
            <a href="<?php echo base_url(); ?>" class="navbar-brand custom-navbar-brand">
              <!-- Menampilkan Logo -->
              <img src="<?php echo base_url(); ?>public/images/logo.png" alt="Logo">

              <!-- Menampilkan Nama Site -->
              <b><?php if (!empty($site_name)) {
                    echo $site_name;
                  } ?></b>
            </a>
          </div>
    ...
    <footer class="main-footer no-print">
      ...
      <div class="container">
        <strong>&copy; 2026 manusunangiri@gmail.com</strong>
      </div><!-- /.container -->
    </footer>
  </div><!-- ./wrapper -->
